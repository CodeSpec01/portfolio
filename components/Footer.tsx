...
const Footer = () => {
  ...
  const links = [
    { title: "Sitemap", items: [{ title: "Home", link: "/" }, { title: "About", link: "/about" }, { title: "My Projects", link: "/projects" }, { title: "Other Projects", link: "/others" }, { title: "Journey to the Website", link: "/journey" }] },
  ];
